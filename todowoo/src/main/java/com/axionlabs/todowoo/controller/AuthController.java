...
import com.axionlabs.todowoo.dto.user.response.UserResponseDto;
import com.axionlabs.todowoo.service.impl.IAuthService;
...
@Tag(
        name = "Authentication APIs - TodoWoo",
        description = "Handles user authentication, registration, and session management for the TodoWoo application."
)
